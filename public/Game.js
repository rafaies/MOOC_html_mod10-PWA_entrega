...
class Game {
    ...
    endGame () {
        this.ended = true;
        let endMessage = this.player.lives > 0 ? PLAYER_PICTURE_WIN : GAME_OVER_PICTURE;
        let gameOver = new Entity(this, this.width / 2, "auto", this.width / 4, this.height / 4, 0, endMessage);
        gameOver.render();
    }
